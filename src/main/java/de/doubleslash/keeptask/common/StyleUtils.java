...
public class StyleUtils {
   ...
   *
   * @param style     A String representing a JavaFX style.
   * @param attribute A String representing a JavaFX style attribute.
   * @param newValue  A String representing the value that should be assigned to the given JavaFX
   *                  style attribute.
   * @return A String representing the new JavaFX style.
   */
  public static String changeStyleAttribute(final String style, final String attribute,
